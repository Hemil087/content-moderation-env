    ...
    "easy": [
        {
            ...
            "post_metadata": {
                ...
                "author_account_age_days": 15,
                "author_prior_violations": 2,
                "author_verified": False,
                "author_follower_count": 45,
                "has_media": False,
                "engagement_count": 3200,
                "reporter_accuracy_rate": 0.91,
                "report_category": "hate_speech",
                "auto_flag_score": 0.97,
            },
            "ground_truth": {
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "author_account_age_days": 1825,
                "author_prior_violations": 0,
                "author_verified": True,
                "author_follower_count": 12400,
                "has_media": False,
                "engagement_count": 890,
                "reporter_accuracy_rate": 0.42,
                "report_category": "hate_speech",
                "auto_flag_score": 0.31,
            },
            "ground_truth": {
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "has_media": False,
                "engagement_count": 5400,
                "reporter_accuracy_rate": 0.88,
                "report_category": "hate_speech",
                "auto_flag_score": 0.95,
            },
            "ground_truth": {
                "expected_action": "remove_content",
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "reporter_accuracy_rate": 0.30,
                "report_category": "violence",
                "auto_flag_score": 0.15,
            },
            "ground_truth": {
                "expected_action": "allow_content",
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "author_prior_violations": 0,
                "author_verified": False,
                "author_follower_count": 310,
                "has_media": False,
                "engagement_count": 2100,
                "reporter_accuracy_rate": 0.85,
                "report_category": "hate_speech",
                "auto_flag_score": 0.93,
            },
            "ground_truth": {
                "expected_action": "remove_content",
    ...
    "medium": [
        {
            ...
            "post_metadata": {
                ...
                "author_prior_violations": 1,
                "author_verified": False,
                "author_follower_count": 2100,
                "has_media": False,
                "engagement_count": 670,
                "reporter_accuracy_rate": 0.78,
                "report_category": "hate_speech",
                "auto_flag_score": 0.72,
                "current_events_context": "National election in 3 days — platform has activated heightened scrutiny protocol for political content",
            },
            "ground_truth": {
                "expected_action": "remove_content",
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "author_prior_violations": 0,
                "author_verified": False,
                "author_follower_count": 8500,
                "has_media": True,
                "engagement_count": 15000,
                "reporter_accuracy_rate": 0.65,
                "report_category": "hate_speech",
                "auto_flag_score": 0.58,
            },
            "ground_truth": {
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "author_prior_violations": 0,
                "author_verified": True,
                "author_follower_count": 34000,
                "has_media": False,
                "engagement_count": 22000,
                "is_trending": True,
                "reporter_accuracy_rate": 0.73,
                "report_category": "hate_speech",
                "auto_flag_score": 0.61,
            },
            "ground_truth": {
                "expected_action": "remove_content",
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "author_prior_violations": 0,
                "author_verified": False,
                "author_follower_count": 560,
                "has_media": False,
                "engagement_count": 140,
                "reporter_accuracy_rate": 0.55,
                "report_category": "hate_speech",
                "auto_flag_score": 0.44,
            },
            "ground_truth": {
                "expected_action": "allow_content",
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "has_media": True,
                "engagement_count": 8700,
                "reporter_accuracy_rate": 0.70,
                "report_category": "graphic_violence",
                "auto_flag_score": 0.82,
                "current_events_context": "Major earthquake occurred 48 hours ago — high volume of graphic content being shared across platform",
            },
            "ground_truth": {
                "expected_action": "add_warning_label",
    ...
    "hard": [
        {
            ...
            "post_metadata": {
                ...
                "original_moderator_reasoning": "Post uses sarcasm to mock a protected group. Sarcastic framing does not exempt content from dehumanization policy. Pattern matches prior removals P-001 and P-015.",
                "platform": "appeal_queue",
                "content_type": "appeal",
                "timestamp": "2024-03-25T09:00:00Z",
                "appeal_submission_date": "2024-03-25T08:30:00Z",
                "author_account_age_days": 540,
                "author_prior_violations": 1,
                "author_verified": False,
                "author_follower_count": 1800,
                "has_media": False,
                "engagement_count": 320,
                "reporter_accuracy_rate": 0.0,
                "report_category": "appeal",
                "auto_flag_score": 0.76,
            },
            "ground_truth": {
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "original_moderator_reasoning": "Flagged by automated immigration-content classifier (score: 0.81). Human moderator confirmed removal based on topic match without reviewing that content was a mainstream news article.",
                "platform": "appeal_queue",
                "content_type": "appeal",
                "timestamp": "2024-03-26T11:30:00Z",
                "appeal_submission_date": "2024-03-26T10:00:00Z",
                "author_account_age_days": 2920,
                "author_prior_violations": 0,
                "author_verified": True,
                "author_follower_count": 15000,
                "has_media": False,
                "engagement_count": 1100,
                "reporter_accuracy_rate": 0.0,
                "report_category": "appeal",
                "auto_flag_score": 0.81,
            },
            "ground_truth": {
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "current_events_context": "Recent surge in immigration-related content following policy announcement — moderation team on high alert for coded language",
            },
            "ground_truth": {
                "expected_action": "remove_content",
        ...
        },
        {
            ...
            "post_metadata": {
                ...
                "original_moderator_reasoning": "Automated system flagged as targeted harassment. Human moderator upheld without reviewing that content was clearly satirical commentary on a public figure's actions.",
                "platform": "appeal_queue",
                "content_type": "appeal",
                "timestamp": "2024-03-28T13:45:00Z",
                "appeal_submission_date": "2024-03-28T12:00:00Z",
                "author_account_age_days": 1460,
                "author_prior_violations": 0,
                "author_verified": False,
                "author_follower_count": 3200,
                "has_media": False,
                "engagement_count": 670,
                "reporter_accuracy_rate": 0.0,
                "report_category": "appeal",
                "auto_flag_score": 0.45,
            },
            "ground_truth": {
                "expected_action": "overturn_removal",

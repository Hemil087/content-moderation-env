...
"""
FastAPI application for the Content Moderation Env Environment.

This module creates an HTTP server that exposes the ContentModerationEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn content_moderation_env.server.app:app --workers 4
    """
    import uvicorn
